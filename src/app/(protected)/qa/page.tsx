...
// import { askQuestion } from "../dashboard/actions";
...
//       console.log("output", output, "project name", project?.projectName);
//       setFilesRef(files);
...
//             <div
//               key={index}
//               className={`mb-2 rounded-xl p-3 break-words ${
//                 message.sender === "user"
//                   ? "bg-muted text-foreground align-self-end self-end"
//                   : ""
//               } w-fit max-w-[80%]`}
//             >
//               {message.text}
...
//       <div className="flex w-full flex-col items-center justify-center space-x-2 rounded-xl px-2 py-2">
//         <Textarea
//           ref={textareaRef}
//           value={input}
...
//           className="placeholder:font-xl max-h-40 flex-1 resize-none overflow-y-auto px-2 py-2 whitespace-pre-wrap"
//         />
//       </div>
//       <Button onClick={handleSendMessage} className="bg-muted">
//         Send
//       </Button>
//     </div>
//   );
